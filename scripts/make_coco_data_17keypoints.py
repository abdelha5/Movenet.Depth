...
if __name__ == '__main__':
    ...
    img_dir = "/mnt/fast0/asmi20/movenet.pytorch/data/val2017"
    labels_path = "/mnt/fast0/asmi20/movenet.pytorch/data/annotations/person_keypoints_val2017.json"
    output_name = './data/cropped/val2017.json'
    main(img_dir, labels_path, output_name, output_img_dir)

    

    img_dir = "/mnt/fast0/asmi20/movenet.pytorch/data/train2017"
    labels_path = "/mnt/fast0/asmi20/movenet.pytorch/data/annotations/person_keypoints_train2017.json"
